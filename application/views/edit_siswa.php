						...
						<form class="form-horizontal" action="<?php echo base_url(). 'admin/tambah_proses'; ?>" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="nama_bangunan" type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="kondisi_bangunan" type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="kontruksi_bangunan" type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="luas_lantai" type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="tahun_pembangunan" type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="luas_bangunan" type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="biaya_pembangunan" type="text" class="form-control">
									</div>
								</div>
