...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Dapodik </span> Sekolah</a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="<?php echo base_url()?>admin_petugas/logout"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Logout</a></li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="http://localhost/DapodikJgj/admin_petugas"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Beranda </a></li>
			...
			<li class="parent ">
				...
				<ul class="children collapse" id="sub-item-1">
					...
					<li>
						<a class="" href="http://localhost/DapodikJgj/admin_petugas/guru">
							<svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Data Guru
						</a>
					</li>
					<li>
						<a class="" href="http://localhost/DapodikJgj/admin_petugas/kepsek">
							<svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Data Kepala Sekolah
						</a>
					</li>
					<li>
						<a class="" href="http://localhost/DapodikJgj/admin_petugas/tenpendik">
							<svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Data Tenpendik
						</a>
					</li>
				</ul>
			</li>
			<li><a href="http://localhost/DapodikJgj/admin_petugas/user"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg></use></svg> User </a></li>
